...
User user = (User) sContext.getAttribute("user");
if (user == null) {
...
<body>
	...
	<div class="page-content container note-has-grid">
		<ul
			...
			<li class="nav-item"><a href="javascript:void(0)"
				...
				id="note-business"> <i class="icon-briefcase mr-1"></i><span
					class="d-none d-md-block">Work</span></a></li>
			<li class="nav-item"><a href="javascript:void(0)"
				class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2"
				id="note-social"> <i class="icon-share-alt mr-1"></i><span
					class="d-none d-md-block">Personal</span></a></li>
			<li class="nav-item"><a href="javascript:void(0)"
				class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2"
				id="note-important"> <i class="icon-tag mr-1"></i><span
					class="d-none d-md-block">Projects</span></a></li>
			...
			<li class="nav-item ml-auto"><a href="javascript:void(0)"
				...
				id="add-notes"> <i class="icon-note m-1"></i><span
					class="d-none d-md-block font-14">Add Notes</span></a></li>


			<li class="nav-item ml-auto"><a href="javascript:void(0)"
				class="nav-link btn-primary rounded-pill d-flex align-items-center px-3"
				id="profile"> <i class="icon-note m-1"></i><span
					class="d-none d-md-block font-14">Profile</span></a></li>
		</ul>
		<%
		try {
		...
		<%
		session.removeAttribute("loginSuccess"); // Remove session attribute after displaying message
		%>
		<%
		}
		} catch (Exception e) {
		...
		<%
		try {
			if (session.getAttribute("noteAdded") != null && (Boolean) session.getAttribute("noteAdded")) {
		%>
		<div class="alert alert-success alert-dismissible fade show"
			role="alert">
			<strong>Success !</strong> e-Note Added Successfully...
		...
		<%
		session.removeAttribute("noteAdded"); // Remove session attribute after displaying message
		%>
		<%
		}
		} catch (Exception e) {
				...
				<div class="col-md-4 single-note-item all-category" style>
					<div class="card card-body">
						...
						<h5 class="note-title text-truncate w-75 mb-0"
							...
							Demo Title <i class="point fa fa-circle ml-1 font-10"></i>
						</h5>
						<p class="note-date font-12 text-muted">31 March 2024</p>
						...
						<div class="d-flex align-items-center">
							<span class="mr-1"><i class="fa fa-edit favourite-note"></i></span>
								...
								<div class="category-selector btn-group">
									...
									<div class="dropdown-menu dropdown-menu-right category-menu">
										<a
											...
											href="javascript:void(0);"> <i
											class="mdi mdi-checkbox-blank-circle-outline mr-1"></i>
											Social
										</a> <a
	...
	<div class="modal fade" id="profile1" tabindex="-1" role="dialog"
		aria-labelledby="addnotesmodalTitle" style="display: none;"
		aria-hidden="true">
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content border-0">
				...
				<div class="modal-body">
					<div class="notes-box">
						<div class="notes-content">
							<form action="add-note" method="post" id="addnotesmodalTitle">
								<div class="row">
									<div class="col-md-12 mb-3">
										<div class="note-title">
											<label>Note Title</label> <input type="text"
												id="note-has-title" name="title" class="form-control"
												placeholder="Title" />
										</div>
									</div>
									<div class="col-md-12">
										<div class="note-description">
											...
											<textarea id="note-has-description" name="desc"
								...
								<div class="modal-footer">
									...
									<button class="btn btn-danger" data-dismiss="modal">Discard</button>
									<input type="submit" id="btn-n-add" value="Add"
										class="btn btn-info">
								</div>
							</form>
						</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			function addLabelGroups() {
				$('.category-selector .badge-group-item').off('click').on(
						'click',
						function(event) {
